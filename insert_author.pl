...
$sth11=$dbh->prepare("CREATE TABLE author(authorname varchar(400), authid int(6) auto_increment, primary key(authid))auto_increment=10001 ENGINE=MyISAM DEFAULT CHARSET=utf8mb4;");
$sth11->execute();
$sth11->finish(); 
